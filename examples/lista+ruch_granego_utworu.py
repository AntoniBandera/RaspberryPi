...
#		y = (24-8)+math.floor(10.0*math.sin(x/83.0*2.0*math.pi))
		...
		width, height = draw.textsize(c, font=font)
		x += width
	draw.text((0, 0), list[which_song_is_playing-3] , font=font1, fill=0)
	draw.text((0, 8), list[which_song_is_playing-2] , font=font1, fill=0)
	draw.text((0, 16), list[which_song_is_playing-1] , font=font1, fill=0)

	draw.text((0, y), '4', font=font, fill=0)

	draw.text((0, 37), list[which_song_is_playing+1] , font=font1, fill=0)
